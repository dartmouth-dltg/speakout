...
import { c as convertConfigToRc } from './shared/eslint-compat-utils.CbZ7L123.mjs';
import { g as getUnsupported } from './shared/eslint-compat-utils.D975eCvH.mjs';
import 'module';
...
function getESLint() {
  ...
  function getESLintInternal() {
    ...
    return getUnsupported().FlatESLint || (eslint.ESLint ? getESLintClassFromLegacyESLint(
      eslint.ESLint
